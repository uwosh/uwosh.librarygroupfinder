...
from uwosh.librarygroupfinder import config
...
librarygroupfinderMessageFactory = MessageFactory('uwosh.librarygroupfinder')
...
def initialize(context):
    ...
    from content import groupFinderEvent, groupSpecialist, groupLocation
