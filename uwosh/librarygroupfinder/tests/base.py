...
def setup_product():
    ...
    import uwosh.librarygroupfinder
    zcml.load_config('configure.zcml', uwosh.librarygroupfinder)
    ...
    ztc.installPackage('uwosh.librarygroupfinder')
...
setup_product()
ptc.setupPloneSite(products=['uwosh.librarygroupfinder'])
